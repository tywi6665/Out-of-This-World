...
const InnerPlanets = () => {
    ...
    const [innerPlanets, setInnerPlanets] = useState([
        ...
        { name: "venus", tilt: 2.64, radius: 6051.8, period: -243, colors: ["#f8e2b0", "#d3a567"], moons: [] },
        {
            ...
            moons: [
                { name: "the-moon", radius: 1736, orbitalDistance: 385000, colors: ["grey", "lightgrey"], url: "https://upload.wikimedia.org/wikipedia/commons/thumb/e/e1/FullMoon2010.jpg/1280px-FullMoon2010.jpg" }
            ]
        },
        {
            name: "mars", tilt: 6.68, radius: 3389.5, period: 1.03, colors: ["#ef1501", "#ad0000"],
            moons: [
                { name: "phobos", radius: 110, orbitalDistance: 9350, colors: ["grey"], url: "https://upload.wikimedia.org/wikipedia/commons/thumb/5/5c/Phobos_colour_2008.jpg/1024px-Phobos_colour_2008.jpg" },
                { name: "deimos", radius: 60, orbitalDistance: 23460, colors: ["grey"], url: "https://upload.wikimedia.org/wikipedia/commons/8/8d/Deimos-MRO.jpg" }
            ]
        }
    ])
